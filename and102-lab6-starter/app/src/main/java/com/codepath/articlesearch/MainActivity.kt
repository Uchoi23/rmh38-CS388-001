...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView.setOnItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.bestSellerBooks_item -> fragment = bestSellerBooksFragment
                R.id.articleSearch_item -> fragment = articleListFragment
            }
        ...
        bottomNavigationView.selectedItemId = R.id.bestSellerBooks_item
    }
}